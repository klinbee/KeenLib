...
public record ArcCosine(DensityFunction arg)
    ...
    private static final KeyDispatchDataCodec<ArcCosine> CODEC =
    ...
    public static final TypedCodec<Codec<? extends DensityFunction>> TYPED_CODEC = new TypedCodec<>("acos", CODEC.codec());
